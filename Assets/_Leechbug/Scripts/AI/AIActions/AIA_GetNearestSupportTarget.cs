...
[CreateAssetMenu(fileName = "GetNearestSupportTarget", menuName = "FishAI/Actions/GetNearestSupportTarget")]
public class AIA_GetNearestSupportTarget : AIAction {
	...
	public override void Act(BaseAIController controller) {
		...
		if (newTarg == null) {
			Debug.Log("NO TARGET FOUND (in AIA_GetNearestSupportTarget.cs)");
		}

		controller.FishAIStateInfo.SupportTarget = newTarg;
	}
